...
class phpXChat
{
  ...
  function FilterSmiley($msg)
  {
    ...
    //pxlog($search,"chat", $c->id);
    //pxlog($replace,"chat", $c->id);
    //pxlog($msg,"chat", $c->id);
    ...
    if (preg_match("/".preg_quote($s_str)."/i", $msg))
      {
	$msg = preg_replace("/".preg_quote($s_str)."/i", '<img src="'.$s_file.'" alt="'.$s_str.'" />', $msg);
	//	  return $msg;
      }
    */

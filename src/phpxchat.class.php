...
class phpXChat
{
  ...
  function phpXChat( $params = array() )
  {
    ...
    $c =& phpXChatConfig::Instance( $params );
    ...
    function handleRequest($request, $shownotice = true)
      {
        ...
        return phpXChat::HandleRequest($request);
      }
  ...
  function FilterMsg($msg)
  {
    ...
    foreach($c->smileys as $s_str => $s_file)
    {
      $msg = str_replace($s_str, '<img src="../smileys/'.$c->smileytheme.'/'.$s_file.'" alt="'.$s_str.'" />', $msg);
    }
    ...
    */
    ...
    $msg  = str_replace(phpXChat::FilterNickname($c->nick), "<strong>".phpXChat::FilterNickname($c->nick)."</strong>", $msg);
    return $msg;
  }
  ...
  {
    $c =& phpXChatConfig::Instance();
    phpXChat::Cmd_updateMyNick($xml_reponse);
    phpXChat::Cmd_getOnlineNick($xml_reponse);
  ...
  function Cmd_quit(&$xml_reponse)
  {
    ...
    if ($container->removeNick($c->nick))
      phpXChat::Cmd_notice($xml_reponse, $c->nick." quit");
    else
      phpXChat::Cmd_notice($xml_reponse, "error: ".$c->nick." can't quit");
  ...
  function Cmd_updateMyNick(&$xml_reponse)
  {
    ...
    if (!$ok)
      phpXChat::Cmd_error(&$xml_reponse, "Cmd_updateMyNick failed");
  }
  ...
  function Cmd_send(&$xml_reponse, $msg)
  {
    ...
    $nick = phpXChat::FilterNickname($c->nick);
    $text = phpXChat::FilterMsg($msg);
    ...
    else
    {
      ...
      phpXChat::Cmd_error($xml_reponse, $errors);

...
div.<?php echo $prefix; ?>chat {
  ...
  position: absolute;
  top: 0px;
  /* left and width are adjusted to leave a small margin on the left of the chat area
   * padding css rule doesn't work because the chat zone is generated by JS function */
  left: 0.5%;
  width: 79.5%;
  height: 100%;
  overflow: auto;

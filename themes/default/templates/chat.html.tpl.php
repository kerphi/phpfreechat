<div id="<?php echo $prefix; ?>container">
  ...
  <div id="<?php echo $prefix; ?>input_container">
    ...
    <div id="<?php echo $prefix; ?>cmd_container">
      ...
      <input id="<?php echo $prefix; ?>handle" type="button" title="<?php echo _pfc("Enter your nickname here"); ?>" maxlength="<?php echo $max_nick_len; ?>" value="<?php echo $nick; ?>" onclick="pfc.askNick();" />
